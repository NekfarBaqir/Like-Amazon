...
function ProductsScreen(props){
    ...
    const [coutInStock,setCoutInStock] = useState('');
    ...
    const openModal = (product)=>{
        ...
        setCoutInStock(product.coutInStock);
   ...
   const submitHandler = (e)=>{
       ...
       e.preventDefault();
       dispatch(saveProduct({_id:id,name,price,image,brand,category,coutInStock,description}));
   }
   ...
   return <div className="content content-margined">
       ...
       <form onSubmit={submitHandler}>
           <ul className="form-container">
               ...
               <li>
                   <label htmlFor="brand">coutInStock:</label>
                   <input type="text" name="coutInStock"  value={coutInStock} id="coutInStock" onChange={(e)=>setCoutInStock(e.target.value)}></input>
               </li>
               <li>
               ...
               <li>
       <button type="submit"  className="button cartbtn">{id?"Update":"Create"}</button>
               </li>
               <li>
